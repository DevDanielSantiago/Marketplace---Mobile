...
export const gluestackUIConfig = createConfig({
  ...
  tokens: {
    ...
    lineHeights: {
      ...
      '6xl': 72,
      '7xl': 90,
      title_lg: 28.8, // 24px * 1.2 = 28.8 (aproximadamente 29px)
      title_md: 24, // 20px * 1.2 = 24px
      title_sm: 19.2, // 16px * 1.2 = 19.2 (aproximadamente 20px)
      title_xs: 16.8, // 14px * 1.2 = 16.8 (aproximadamente 18px)
      body_md: 22.4, // 16px * 1.4 = 22.4 (aproximadamente 22px)
      body_sm: 19.6, // 14px * 1.4 = 19.6 (aproximadamente 20px)
      body_xs: 16.8, // 12px * 1.4 = 16.8 (aproximadamente 18px)
    },
    fontWeights: {
      hairline: '100',
      thin: '200',
